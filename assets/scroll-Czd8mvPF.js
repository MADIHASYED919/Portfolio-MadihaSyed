import{r as e,j as o}from"./index-DlrHnbQo.js";import{i}from"./index-BpyP5p_n.js";function c(){const[t,s]=e.useState(!1);e.useEffect(()=>{const r=()=>{s(window.scrollY>300)};return window.addEventListener("scroll",r),()=>window.removeEventListener("scroll",r)},[]);const n=()=>{window.scrollTo({top:0,behavior:"smooth"})};return t?o.jsxs("button",{onClick:n,className:`group fixed bottom-6 right-6 flex items-center\r
